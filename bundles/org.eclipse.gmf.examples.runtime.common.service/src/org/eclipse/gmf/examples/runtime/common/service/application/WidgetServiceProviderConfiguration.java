...
/**
 * Provider configuration for the WidgetService. It helps in filtering out and
 * delay loading unrelated providers.
 *
 */
public class WidgetServiceProviderConfiguration extends AbstractProviderConfiguration {
	...
	/**
	 * Builds a new provider contribution descriptor by parsing its configuration
	 * element
	 *
	...
	/**
	 * Creates a new <code>ProviderContributionDescriptor</code> instance given a
	 * provider configuration element
	 *
