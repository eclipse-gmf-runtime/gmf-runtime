...
public class ExampleDiagramGeoshapePluginImages {
	...
	// Image descriptors.
	public static final ImageDescriptor DESC_GEOSHAPES_WIZARD = create(PREFIX_WIZARD + "geoshapes_wiz.gif"); //$NON-NLS-1$
	...
	private static ImageDescriptor create(String imageName) {
		return AbstractUIPlugin.imageDescriptorFromPlugin(DiagramPlugin.getPluginId(), imageName);
	}
}
