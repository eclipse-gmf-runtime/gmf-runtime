...
public class ElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOutputTerminalsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Element_outputTerminals_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Element_outputTerminals_feature", //$NON-NLS-1$ //$NON-NLS-2$
								"_UI_Element_type"), //$NON-NLS-1$
						SemanticPackage.Literals.ELEMENT__OUTPUT_TERMINALS, false, null, null, null));
	}
	...
	protected void addInputTerminalsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Element_inputTerminals_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Element_inputTerminals_feature", //$NON-NLS-1$ //$NON-NLS-2$
								"_UI_Element_type"), //$NON-NLS-1$
						SemanticPackage.Literals.ELEMENT__INPUT_TERMINALS, false, null, null, null));
	}
