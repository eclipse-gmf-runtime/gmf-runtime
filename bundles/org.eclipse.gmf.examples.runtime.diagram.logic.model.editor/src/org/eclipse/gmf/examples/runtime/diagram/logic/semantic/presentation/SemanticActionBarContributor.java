 ...
 * begin-user-doc --> It is customized from its EMF-generated form to provide
 * alternative implementations of the undo and redo menu actions (delegating to
 * the operation history) and additional example actions such as initiation of
 * long-running background reader jobs. <!-- end-user-doc -->
 * 
 * @generated
 */
public class SemanticActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			LogicsemanticEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
	{
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			LogicsemanticEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				LogicsemanticEditorPlugin.INSTANCE.getString("_UI_SemanticEditor_menu"), //$NON-NLS-1$
				"org.eclipse.gmf.examples.runtime.diagram.logic.semanticMenuID"); //$NON-NLS-1$
		...
		createChildMenuManager = new MenuManager(
				LogicsemanticEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				LogicsemanticEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
