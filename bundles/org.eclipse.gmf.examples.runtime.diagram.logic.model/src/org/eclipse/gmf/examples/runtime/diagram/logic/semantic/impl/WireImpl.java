 ...
 * <ul>
 * <li>{@link org.eclipse.gmf.examples.runtime.diagram.logic.semantic.impl.WireImpl#getSource
 * <em>Source</em>}</li>
 * <li>{@link org.eclipse.gmf.examples.runtime.diagram.logic.semantic.impl.WireImpl#getTarget
 * <em>Target</em>}</li>
 * </ul>
 * </p>
 *
...
public class WireImpl extends ElementImpl implements Wire {
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SemanticPackage.WIRE__SOURCE, oldSource,
							source));
				}
			}
		}
	...
	public InputTerminal getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SemanticPackage.WIRE__TARGET, oldTarget,
							target));
				}
			}
		}
