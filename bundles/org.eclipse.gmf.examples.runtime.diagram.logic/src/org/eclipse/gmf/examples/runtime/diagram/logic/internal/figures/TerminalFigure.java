...
public class TerminalFigure extends NodeFigure {
	...
	static public class TerminalLocator extends BorderItemLocator {
		...
		public void relocate(IFigure target) {
			...
			target.setBounds(new Rectangle(ptLoc.x - targetRect.width / 2, ptLoc.y - targetRect.height / 2,
	 ...
	 * 
	 * @see
	 * org.eclipse.gmf.runtime.gef.ui.figures.NodeFigure#getSourceConnectionAnchorAt
	 ...
	 * 
	 * @see
	 * org.eclipse.gmf.runtime.gef.ui.figures.NodeFigure#getTargetConnectionAnchorAt
	 * (org.eclipse.draw2d.geometry.Point)
	 */
	@Override
