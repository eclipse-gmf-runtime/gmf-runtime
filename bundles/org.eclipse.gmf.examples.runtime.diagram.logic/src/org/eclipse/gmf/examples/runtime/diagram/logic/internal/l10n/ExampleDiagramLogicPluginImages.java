...
public class ExampleDiagramLogicPluginImages {
	...
	// Image descriptors.
	public static final ImageDescriptor DESC_LOGIC_WIZARD = create(PREFIX_WIZARD + "logic_wiz.gif"); //$NON-NLS-1$
	...
	private static ImageDescriptor create(String imageName) {
		return AbstractUIPlugin.imageDescriptorFromPlugin(LogicDiagramPlugin.getPluginId(), imageName);
	}
}
