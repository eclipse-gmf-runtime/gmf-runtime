...
public class HashUtilTest {
	...
	public void test_hash_byte() {
		...
		assertTrue(37 * Byte.MIN_VALUE == HashUtil.hash(Byte.MIN_VALUE, Byte.MAX_VALUE) - Byte.MAX_VALUE);
	}

	@Test
	public void test_hash_char() {
		assertTrue(37 * 17 == HashUtil.hash(Character.MAX_VALUE) - Character.MAX_VALUE);
		assertTrue(37 * Character.MIN_VALUE == HashUtil.hash(Character.MIN_VALUE, Character.MAX_VALUE)
				- Character.MAX_VALUE);
	}

	@Test
	public void test_hash_double() {
		assertTrue(37 * 17 == HashUtil.hash(Double.doubleToLongBits(Double.MAX_VALUE))
		...
		assertTrue(37 * (int) (Double.doubleToLongBits(Double.MIN_VALUE)
				^ (Double.doubleToLongBits(Double.MIN_VALUE) >>> 32)) == HashUtil
	...
	public void test_hash_float() {
		assertTrue(37 * 17 == HashUtil.hash(Float.MAX_VALUE) - Float.floatToIntBits(Float.MAX_VALUE));
		assertTrue(37 * Float.floatToIntBits(Float.MIN_VALUE) == HashUtil.hash(Float.floatToIntBits(Float.MIN_VALUE),
				Float.MAX_VALUE) - Float.floatToIntBits(Float.MAX_VALUE));
	}

	@Test
	public void test_hash_int() {
		assertTrue(37 * 17 == HashUtil.hash(Integer.MAX_VALUE) - Integer.MAX_VALUE);
		assertTrue(37 * Integer.MIN_VALUE == HashUtil.hash(Integer.MIN_VALUE, Integer.MAX_VALUE) - Integer.MAX_VALUE);
	}

	@Test
	public void test_hash_long() {
		assertTrue(37 * 17 == HashUtil.hash(Long.MAX_VALUE) - (int) (Long.MAX_VALUE ^ (Long.MAX_VALUE >>> 32)));
		assertTrue(37 * (int) (Long.MIN_VALUE ^ (Long.MIN_VALUE >>> 32)) == HashUtil
				.hash((int) (Long.MIN_VALUE ^ (Long.MIN_VALUE >>> 32)), Long.MAX_VALUE)
	...
	public void test_hash_short() {
		...
		assertTrue(37 * Short.MIN_VALUE == HashUtil.hash(Short.MIN_VALUE, Short.MAX_VALUE) - Short.MAX_VALUE);
	}
