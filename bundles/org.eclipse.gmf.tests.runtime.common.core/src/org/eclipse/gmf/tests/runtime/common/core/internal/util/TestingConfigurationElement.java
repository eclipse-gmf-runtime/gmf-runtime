...
public class TestingConfigurationElement implements IConfigurationElement {
	...
	public Object createExecutableExtension(String propertyName) throws CoreException {
		throw new CoreException(new Status(IStatus.ERROR, "", 0, "", null)); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public IConfigurationElement[] getChildren(String name) {
		...
		return ((childrenList != null) && !childrenList.isEmpty())
				? (TestingConfigurationElement[]) childrenList.toArray(EMPTY_TESTING_CONFIG_ELEMENT)
