 ...
 * @author cmcgee
 */
public class SelectableElementTest {
	...
	public void test_getSelectedElementIds() {
		...
		Assertions.assertTrue(hints.contains("brancha")); //$NON-NLS-1$
		Assertions.assertTrue(hints.contains(branchcHint));
		Assertions.assertFalse(hints.contains(branchdHint));
	}
}
