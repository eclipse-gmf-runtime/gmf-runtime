 ...
 * @author ldamus
 */
public class DiagramEditingDomainFactoryTests {
	...
	public void test_getEditingDomain_254621() {
		...
		domain = fixture.createEditingDomain(OperationHistoryFactory.getOperationHistory());
		assertEquals(1, fixture.getConfigureCount(domain));
		...
		domain = fixture.createEditingDomain(new ResourceSetImpl(), OperationHistoryFactory.getOperationHistory());
		assertEquals(1, fixture.getConfigureCount(domain));
	}

	/**
	 * Fixture that keeps track of how many times each editing domain is configured.
	 */
