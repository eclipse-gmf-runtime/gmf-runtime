...
//		assertValidNoteView(diagramLink);
	 ...
	 * assertNotNull(link1); // try to get the edit part IGraphicalEditPart
	 * gEditPart1 = EditPartService.getInstance().createGraphicEditPart(link1);
	 * assertNotNull(gEditPart1); assertFalse(gEditPart1 instanceof
	 * DefaultNodeEditPart); IFigure figure = gEditPart1.getFigure();
	 * assertTrue(figure instanceof NoteFigure); NoteFigure noteFigure =
	 * (NoteFigure)figure; assertTrue(noteFigure.isDiagramLinkMode()); return
	 * gEditPart1; }
	 */
	 ...
	 * DefaultNodeEditPart); IFigure figure = gEditPart1.getFigure();
	 * assertTrue(figure instanceof NoteFigure); NoteFigure noteFigure =
	 * (NoteFigure)figure; assertFalse(noteFigure.isDiagramLinkMode()); return
	 * gEditPart1; }
	 */
	 ...
	 */
	/*
	 * private IGraphicalEditPart assertCorruptView(View link1) { if (link1==null)
	 * return null; assertNotNull(link1); // try to get the edit part
	 * IGraphicalEditPart gEditPart1 =
	 * EditPartService.getInstance().createGraphicEditPart(link1);
	 * assertNotNull(gEditPart1); assertFalse(gEditPart1 instanceof
	 * DefaultNodeEditPart); return null; }
	 */
