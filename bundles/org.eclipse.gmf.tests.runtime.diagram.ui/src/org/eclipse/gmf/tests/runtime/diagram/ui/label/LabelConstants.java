...
class LabelConstants {
	...
	public final static String VIEWTYPE_GEFLABEL_NOTE = LabelNotationType.GEFLABEL_NOTE.getSemanticHint();

	public final static String VIEWTYPE_WRAPPINGLABEL_NOTE = LabelNotationType.WRAPPINGLABEL_NOTE.getSemanticHint();

	public final static String VIEWTYPE_OLDWRAPLABEL_NOTE = LabelNotationType.OLDWRAPLABEL_NOTE.getSemanticHint();

	public final static String VIEWTYPE_WRAPLABEL_NOTE = LabelNotationType.WRAPLABEL_NOTE.getSemanticHint();
