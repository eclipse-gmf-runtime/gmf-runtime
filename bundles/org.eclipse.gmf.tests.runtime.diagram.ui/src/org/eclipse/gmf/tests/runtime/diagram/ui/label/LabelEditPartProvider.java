...
public class LabelEditPartProvider extends AbstractEditPartProvider {
	...
	static public class GEFLabelNoteEditPart extends NoteEditPart {
	...
	static public class WrappingLabelNoteEditPart extends NoteEditPart {
	...
	static public class OldWrapLabelNoteEditPart extends NoteEditPart {
	...
	static public class WrapLabelNoteEditPart extends NoteEditPart {
	...
	static public class GEFLabelTextCompartmentEditPart extends DescriptionCompartmentEditPart {
		...
		public IParser getParser() {
			if (parser == null) {
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(object, CommonParserHint.DESCRIPTION);
	...
	static public class WrappingLabelTextCompartmentEditPart extends DescriptionCompartmentEditPart {
	...
	static public class OldWrapLabelTextCompartmentEditPart extends DescriptionCompartmentEditPart {
		...
		protected ILabelDelegate createLabelDelegate() {
			...
			return new OriginalWrapLabelDelegate((OriginalWrapLabel) getFigure());
		}
	...
	static public class WrapLabelTextCompartmentEditPart extends DescriptionCompartmentEditPart {
		...
		protected ILabelDelegate createLabelDelegate() {
			...
			return new WrappingLabelDelegate((WrapLabel) getFigure());
		}
	...
	{
		shapeMap.put(LabelConstants.VIEWTYPE_GEFLABEL_NOTE, GEFLabelNoteEditPart.class);
		shapeMap.put(LabelConstants.VIEWTYPE_WRAPPINGLABEL_NOTE, WrappingLabelNoteEditPart.class);
		shapeMap.put(LabelConstants.VIEWTYPE_OLDWRAPLABEL_NOTE, OldWrapLabelNoteEditPart.class);
		shapeMap.put(LabelConstants.VIEWTYPE_WRAPLABEL_NOTE, WrapLabelNoteEditPart.class);
	}

	/** list of supported text editparts. */
	private Map textCompartmentMap = new HashMap();
	{
		textCompartmentMap.put(LabelConstants.VIEWTYPE_GEFLABEL, GEFLabelTextCompartmentEditPart.class);
		textCompartmentMap.put(LabelConstants.VIEWTYPE_WRAPPINGLABEL, WrappingLabelTextCompartmentEditPart.class);
		textCompartmentMap.put(LabelConstants.VIEWTYPE_OLDWRAPLABEL, OldWrapLabelTextCompartmentEditPart.class);
		textCompartmentMap.put(LabelConstants.VIEWTYPE_WRAPLABEL, WrapLabelTextCompartmentEditPart.class);
	}
