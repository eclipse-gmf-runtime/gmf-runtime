 ...
 * '<em><b>Band</b></em>', and utility methods for working with them. <!--
 * end-user-doc -->
 * 
...
public final class Band extends AbstractEnumerator {
	/**
	 * The '<em><b>Junior</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #JUNIOR_LITERAL
	 * @model name="junior"
	...
	/**
	 * The '<em><b>Senior</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #SENIOR_LITERAL
	 * @model name="senior"
	...
	/**
	 * The '<em><b>Manager</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #MANAGER_LITERAL
	 * @model name="manager"
	...
	/**
	 * The '<em><b>Director</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Executive</b></em>' literal value. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Junior</b></em>' literal object. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Junior</b></em>' literal object isn't clear, there
	...
	/**
	 * The '<em><b>Senior</b></em>' literal object. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Senior</b></em>' literal object isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Manager</b></em>' literal object. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Manager</b></em>' literal object isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Director</b></em>' literal object. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * The '<em><b>Executive</b></em>' literal object. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * An array of all the '<em><b>Band</b></em>' enumerators. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	private static final Band[] VALUES_ARRAY = new Band[] { JUNIOR_LITERAL, SENIOR_LITERAL, MANAGER_LITERAL,
			DIRECTOR_LITERAL, EXECUTIVE_LITERAL, };
	...
	public static Band get(int value) {
		switch (value) {
		case JUNIOR:
			return JUNIOR_LITERAL;
		case SENIOR:
			return SENIOR_LITERAL;
		case MANAGER:
			return MANAGER_LITERAL;
		case DIRECTOR:
			return DIRECTOR_LITERAL;
		case EXECUTIVE:
			return EXECUTIVE_LITERAL;
		}
		return null;
	}
