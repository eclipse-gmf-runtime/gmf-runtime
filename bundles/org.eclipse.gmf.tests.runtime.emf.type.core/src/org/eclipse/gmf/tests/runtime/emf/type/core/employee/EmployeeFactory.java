...
public interface EmployeeFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Office</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Department</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Student</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Client</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
