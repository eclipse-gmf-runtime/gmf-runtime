 ...
 * '<em><b>Client</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.ClientImpl#getFirstName
 * <em>First Name</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.ClientImpl#getLastName
 * <em>Last Name</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.ClientImpl#getRepresents
 * <em>Represents</em>}</li>
 * </ul>
 * </p>
 *
...
public class ClientImpl extends EModelElementImpl implements Client {
	...
	public void setFirstName(String newFirstName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.CLIENT__FIRST_NAME, oldFirstName,
					firstName));
		}
	}
	...
	public void setLastName(String newLastName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.CLIENT__LAST_NAME, oldLastName,
					lastName));
		}
	}
	...
	public Customer getRepresents() {
		if (eContainerFeatureID() != EmployeePackage.CLIENT__REPRESENTS) {
			return null;
		}
	...
	public void setRepresents(Customer newRepresents) {
		if (newRepresents != eInternalContainer()
				|| (eContainerFeatureID() != EmployeePackage.CLIENT__REPRESENTS && newRepresents != null)) {
			...
			if (newRepresents != null) {
				msgs = ((InternalEObject) newRepresents).eInverseAdd(this, EmployeePackage.CUSTOMER__REPRESENTATIVES,
						Customer.class, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.CLIENT__REPRESENTS, newRepresents,
					newRepresents));
		}
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case EmployeePackage.CLIENT__REPRESENTS:
			return eInternalContainer().eInverseRemove(this, EmployeePackage.CUSTOMER__REPRESENTATIVES, Customer.class,
					msgs);
		}
