 ...
 * <ul>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#getSalary
 * <em>Salary</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#getBand
 * <em>Band</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#getNumber
 * <em>Number</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#isSecurityClearance
 * <em>Security Clearance</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#getDepartment
 * <em>Department</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#isFullTime
 * <em>Full Time</em>}</li>
 * <li>{@link org.eclipse.gmf.tests.runtime.emf.type.core.employee.impl.EmployeeImpl#getOffice
 * <em>Office</em>}</li>
 * </ul>
 * </p>
 *
...
public class EmployeeImpl extends EModelElementImpl implements Employee {
	...
	/**
	 * The default value of the '{@link #isSecurityClearance() <em>Security
	 * Clearance</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The flag representing the value of the '{@link #isSecurityClearance()
	...
	/**
	 * The default value of the '{@link #isFullTime() <em>Full Time</em>}'
	...
	/**
	 * The flag representing the value of the '{@link #isFullTime() <em>Full
	...
	/**
	 * The cached value of the '{@link #getOffice() <em>Office</em>}' containment
	...
	public NotificationChain basicSetOffice(Office newOffice, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EmployeePackage.EMPLOYEE__OFFICE, oldOffice, newOffice);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setOffice(Office newOffice) {
		if (newOffice != office) {
			...
			if (office != null) {
				msgs = ((InternalEObject) office).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EmployeePackage.EMPLOYEE__OFFICE, null, msgs);
			}
			if (newOffice != null) {
				msgs = ((InternalEObject) newOffice).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - EmployeePackage.EMPLOYEE__OFFICE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.EMPLOYEE__OFFICE, newOffice,
					newOffice));
		}
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case EmployeePackage.EMPLOYEE__DEPARTMENT:
			return eInternalContainer().eInverseRemove(this, EmployeePackage.DEPARTMENT__MEMBERS, Department.class,
					msgs);
		}
	...
	public void setSecurityClearance(boolean newSecurityClearance) {
		...
		if (newSecurityClearance) {
			eFlags |= SECURITY_CLEARANCE_EFLAG;
		} else {
			eFlags &= ~SECURITY_CLEARANCE_EFLAG;
		}
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.EMPLOYEE__SECURITY_CLEARANCE,
					oldSecurityClearance, newSecurityClearance));
		}
	}
	...
	public Department getDepartment() {
		if (eContainerFeatureID() != EmployeePackage.EMPLOYEE__DEPARTMENT) {
			return null;
		}
	...
	public void setDepartment(Department newDepartment) {
		if (newDepartment != eInternalContainer()
				|| (eContainerFeatureID() != EmployeePackage.EMPLOYEE__DEPARTMENT && newDepartment != null)) {
			...
			if (newDepartment != null) {
				msgs = ((InternalEObject) newDepartment).eInverseAdd(this, EmployeePackage.DEPARTMENT__MEMBERS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.EMPLOYEE__DEPARTMENT, newDepartment,
					newDepartment));
		}
	}
	...
	public void setFullTime(boolean newFullTime) {
		...
		if (newFullTime) {
			eFlags |= FULL_TIME_EFLAG;
		} else {
			eFlags &= ~FULL_TIME_EFLAG;
		}
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeePackage.EMPLOYEE__FULL_TIME, oldFullTime,
					newFullTime));
		}
	}
