...
public class UndoableModelPropertySectionTest {
	...
	public void testEditorValueConsistentIfOperationIsCanceled() {
		...
		final UndoableModelPropertySheetEntryForTest root = new UndoableModelPropertySheetEntryForTest(
		...
		final UndoableModelPropertySheetEntryForTest entry = (UndoableModelPropertySheetEntryForTest) root
				.createChildEntry();
	...
	private final class UndoableModelPropertySheetEntryForTest extends UndoableModelPropertySheetEntry {
		...
		public PropertySheetEntry createChildEntry() {
			UndoableModelPropertySheetEntryForTest child = new UndoableModelPropertySheetEntryForTest(
					getOperationHistory());
			child.parent = this;
			return child;
		}
