...
public class ModelingAssistantServiceTests {
	 ...
	 */
	protected static class MyModelingAssistantService extends ModelingAssistantService {
	 ...
	 */
	public static class MyElementType extends ElementType {
	...
	public static class MyModelingAssistantProviderViaXML extends ModelingAssistantProvider {
	...
	public void testCapabilityFiltering() throws Exception {
		...
		getModelingAssistantService().addModelingAssistantProvider(ProviderPriority.LOW, provider1Descriptor);
		...
		getModelingAssistantService().addModelingAssistantProvider(ProviderPriority.HIGH, provider2Descriptor);

		// test service
		List allTypes = getModelingAssistantService().getTypesForPopupBar(null);
		...
		List allTypesAgain = getModelingAssistantService().getTypesForPopupBar(null);
	 ...
	 * the editor in the extension point XML.This test uses the modeling assistant
	 * extension point defined in the XML for this plugin.
	 *
	 * @throws Exception
	 */
