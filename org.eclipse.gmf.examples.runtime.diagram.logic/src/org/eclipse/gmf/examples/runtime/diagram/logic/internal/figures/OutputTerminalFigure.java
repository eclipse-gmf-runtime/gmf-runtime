...
public class OutputTerminalFigure extends TerminalFigure {
    ...
    static {
		...
		connector.addPoint(MapMode.DPtoLP(2), MapMode.DPtoLP(3));
	}
	 ...
	 * @param edge
	 */
	public OutputTerminalFigure(DrawConstant side, String ID) {
		super(side);
		Dimension preferredSize = new Dimension(MapMode.DPtoLP(4), MapMode.DPtoLP(5));
		setSize(preferredSize);
		
		fixedAnchor = new FixedConnectionAnchor(this);
		fixedAnchor.offsetH = MapMode.DPtoLP(2);
		fixedAnchor.offsetV = MapMode.DPtoLP(1);
	...
	protected void paintFigure(Graphics graphics) {	
		...
		copy.translate(MapMode.DPtoLP(0), MapMode.DPtoLP(1));
