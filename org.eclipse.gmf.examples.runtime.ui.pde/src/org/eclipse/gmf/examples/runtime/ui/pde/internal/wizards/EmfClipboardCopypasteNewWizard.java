...
/**
 * This wizard generates the EMF Clipboard Copy/Paste plug-in sample.
 */
public class EmfClipboardCopypasteNewWizard
	extends ProjectUnzipperNewWizard {

	/**
	 * Constructor
	 */
	public EmfClipboardCopypasteNewWizard() {
		super("exampleProjectLocation", //$NON-NLS-1$
			ResourceManager.getI18NString("emf.clipboard.copypaste.title"), //$NON-NLS-1$
