...
/**
 * This wizard generates the EMF OCL Query plug-in sample.
 */
public class EmfOclQueryNewWizard
	extends ProjectUnzipperNewWizard {

	/**
	 * Constructor
	 */
	public EmfOclQueryNewWizard() {
		super("exampleProjectLocation", //$NON-NLS-1$
			ResourceManager.getI18NString("emf.ocl.query.title"), //$NON-NLS-1$
			ResourceManager.getI18NString("emf.ocl.query.desc"), //$NON-NLS-1$
			new URL[] {
				GmfExamplesPlugin.getDefault().find(new Path("examples/emf-ocl-query.zip")), //$NON-NLS-1$
