...
/**
 * This wizard generates the EMF Query Statements plug-in sample.
 */
public class EmfQueryStatementsNewWizard
	extends ProjectUnzipperNewWizard {

	/**
	 * Constructor
	 */
	public EmfQueryStatementsNewWizard() {
		super("exampleProjectLocation", //$NON-NLS-1$
			ResourceManager.getI18NString("emf.query.statements.title"), //$NON-NLS-1$
			ResourceManager.getI18NString("emf.query.statements.desc"), //$NON-NLS-1$
			new URL[] {
				GmfExamplesPlugin.getDefault().find(new Path("examples/emf-query-statements.zip")), //$NON-NLS-1$
