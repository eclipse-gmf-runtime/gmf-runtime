	...
	*/
	...
	protected ResourceBundle createMessagesBundle() {
		try {
			...
			Trace.catching(CommonCorePlugin.getDefault(), CommonCoreDebugOptions.EXCEPTIONS_CATCHING, getClass(), "createMessagesBundle", mre); //$NON-NLS-1$
			Log.error(CommonCorePlugin.getDefault(), CommonCoreStatusCodes.L10N_FAILURE, "createMessagesBundle", mre); //$NON-NLS-1$
	...
	public String getString(String key, String defaultValue) {
		try {
			...
			Trace.catching(CommonCorePlugin.getDefault(), CommonCoreDebugOptions.EXCEPTIONS_CATCHING, getClass(), "getString", mre); //$NON-NLS-1$
			Log.warning(
