...
import org.eclipse.gmf.runtime.diagram.ui.actions.internal.ConnectorLabelMenuManager;
...
import org.eclipse.gmf.runtime.diagram.ui.actions.internal.HideConnectorLabelsAction;
...
import org.eclipse.gmf.runtime.diagram.ui.actions.internal.ShowConnectorLabelsAction;
 ...
 * @canBeSeenBy %level1
 * 
 * The core presentation contribution item provider.
 * It provides contributions generic to all diagram editors
 * 
 */
public class PresentationContributionItemProvider
	extends AbstractContributionItemProvider {

	/**
	 * @see org.eclipse.gmf.runtime.common.ui.services.action.contributionitem.AbstractContributionItemProvider#createCustomContributionItem(java.lang.String, org.eclipse.gmf.runtime.common.ui.services.contributionitem.IWorkbenchPartDescriptor)
	 */
	...
	/**
	 * @see org.eclipse.gmf.runtime.common.ui.services.action.contributionitem.AbstractContributionItemProvider#createMenuManager(java.lang.String, org.eclipse.gmf.runtime.common.ui.services.contributionitem.IWorkbenchPartDescriptor)
	 */
	protected IMenuManager createMenuManager(
		...
		if (menuId.equals(ActionIds.MENU_CONNECTOR_LABEL))
			return new ConnectorLabelMenuManager();
	...
	protected IAction createAction(
		...
		if (actionId.equals(ActionIds.ACTION_SELECT_ALL_CONNECTORS))
			return SelectAllAction.createSelectAllConnectorsAction(
				workbenchPage);		
		...
		if (actionId.equals(ActionIds.ACTION_TOOLBAR_SELECT_ALL_CONNECTORS))
			return SelectAllAction.createToolbarSelectAllConnectorsAction(
				workbenchPage);		
		...
		if (actionId.equals(ActionIds.ACTION_SHOW_CONNECTOR_LABELS))
			return new ShowConnectorLabelsAction(workbenchPage);
		if (actionId.equals(ActionIds.ACTION_HIDE_CONNECTOR_LABELS))
			return new HideConnectorLabelsAction(workbenchPage);
