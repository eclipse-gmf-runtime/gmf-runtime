...
public abstract class PresentationAction
	 ...
	 * 
	 * @return <code>true</code> if action should be enabled, <code>false</code> otherwise
	 */
	 ...
	 * @param progressMonitor	the progress monitor to use during execution
	 */
	 ...
	 * @param request request to use to get the command
	 * @return a command 
	 */
	...
	/** 
	 * Sets the target request to <tt>null</tt>.  This will force the
	 * creation of a new target request on the next {@link #getTargetRequest()}
	 * call.
	 * */
	...
	/**
	 * Executes the given Getter instance in a read action and returns the result
	 * 
	 * @param getter The getter instance
	 * @return The result of the getter instance
	 */
//	protected Object getUsingReadAction(Getter getter) {
//		return getDiagramEditDomain().getModelOperation().getUsingReadAction(
//			DefaultKey.ACTION,
//			getter);
//	}
	 ...
	 * enablement state of the context menu or the operation set depends on 
	 * what is selected in a diagram, then this needs to return true.  If this
	 * action targets the diagram only, then it should return false.
	...
	/**
	 * @param targetRequest The targetRequest to set.
	 */
