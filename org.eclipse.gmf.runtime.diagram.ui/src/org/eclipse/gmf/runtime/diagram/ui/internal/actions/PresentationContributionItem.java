 ...
 * @canBeSeenBy %level1
 * 
 * An abstract implementation of a custom toolbar contribution item for a presenttion
 * engine-based part
 *  
 */
public abstract class PresentationContributionItem
	...
	/**
	 * Constructs a new presentation contribution item
	 * 
	 * @param workbenchPage The workbench page
	 * @param id The item's id
	 */
	public PresentationContributionItem(
