...
public class MResourceFactory
	...
	static {
		...
		saveOptions.put(XMIResource.OPTION_ENCODING, MSLConstants.XMI_ENCODING);
	}
	...
	public Resource createResource(URI uri) {
		...
		if (!resource.getEncoding().equals(MSLConstants.XMI_ENCODING))
			resource.setEncoding(MSLConstants.XMI_ENCODING);
